    ...
    <AnimatePresence>
      {!isDone && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex flex-col justify-between p-8 sm:p-12 md:p-16 bg-[#080808] text-white selection:bg-white selection:text-black"
        >
          {/* Top Status */}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between font-mono text-xs sm:text-sm text-zinc-400">
              ...
              <span className="text-white font-bold tracking-widest">{String(progress).padStart(3, "0")}%</span>
            </div>
